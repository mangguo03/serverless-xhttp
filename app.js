...
// 环境变量
const UUID = process.env.UUID || '1fcd37d4-96df-4bec-9873-36ff255844b2'; // 使用哪吒v1，在不同的平台部署需修改UUID，否则会覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'QWBNzy8WCYfHQAhxEW';             // v1的NZ_CLIENT_SECRET或v0的agent端口  
...
const DOMAIN = process.env.DOMAIN || 'download.yunzhongzhuan.com';                   // 域名或ip,留空将自动获取服务器ip
const NAME = process.env.NAME || '03';                       // 节点名称
